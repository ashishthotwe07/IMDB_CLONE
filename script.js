...
// Load stored suggestions and search term on page load
window.addEventListener("load", () => {
    const storedSuggestions = localStorage.getItem("movieSuggestions");
    if (storedSuggestions) {
        const parsedSuggestions = JSON.parse(storedSuggestions);
        updateMovieSuggestions(parsedSuggestions);
    }
